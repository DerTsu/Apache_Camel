package co.com.ortega3.microservice.resolveEnigmaApi3.config;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("co.com.ortega3.microservice.resolveEnigmaApi3.api"))
