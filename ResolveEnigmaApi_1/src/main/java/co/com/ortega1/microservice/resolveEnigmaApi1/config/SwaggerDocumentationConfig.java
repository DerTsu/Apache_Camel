package co.com.ortega1.microservice.resolveEnigmaApi1.config;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("co.com.ortega1.microservice.resolveEnigmaApi1.api"))
