package co.com.ortega2.microservice.resolveEnigmaApi2.config;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("co.com.ortega2.microservice.resolveEnigmaApi2.api"))
